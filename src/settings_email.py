...
REDIRECT_LINK = {
    "Activation": "https://spo-backend.herokuapp.com/",
}
EMAIL_LINK = {
    "Activation": "https://spo-backend.herokuapp.com/user/register/verify/code={code:s}/",
    "PasswordReset": "https://spo-backend.herokuapp.com/user/resetpass/code={code:s}/",
}
